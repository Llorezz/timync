...
<head>
    ...
    <title>Timync – {{ $title ?? 'Panel' }}</title>
    ...
    <div class="sidebar">
        ...
        <div style="padding: 16px 24px; border-bottom: 1px solid #162544;">
            <div style="display:flex; align-items:center; gap:10px;">
                ...
                <div>
                    <div style="color:white; font-size:13px; font-weight:500;">{{ Auth::user()->name }}</div>
                    <div style="color:#64748b; font-size:11px;">{{ Auth::user()->email }}</div>
                </div>
            </div>
        </div>
        ...
        <nav style="padding: 16px 0;">
            ...
            <a href="{{ route('dashboard') }}" class="nav-item {{ request()->routeIs('dashboard') ? 'active' : '' }}" style="display:flex; align-items:center; gap:12px; padding:11px 24px; color:#94a3b8; text-decoration:none; font-size:14px; font-weight:500;">
...
<a href="{{ route('clientes.index') }}" class="nav-item {{ request()->routeIs('clientes.*') ? 'active' : '' }}" style="display:flex; align-items:center; gap:12px; padding:11px 24px; color:#94a3b8; text-decoration:none; font-size:14px; font-weight:500;">
    ...
    Clientes
            ...
            <a href="{{ route('empleados.index') }}" class="nav-item {{ request()->routeIs('empleados.*') ? 'active' : '' }}" style="display:flex; align-items:center; gap:12px; padding:11px 24px; color:#94a3b8; text-decoration:none; font-size:14px; font-weight:500;">
            ...
            <a href="{{ route('servicios.index') }}" class="nav-item {{ request()->routeIs('servicios.*') ? 'active' : '' }}" style="display:flex; align-items:center; gap:12px; padding:11px 24px; color:#94a3b8; text-decoration:none; font-size:14px; font-weight:500;">
...
<a href="{{ route('citas.index') }}" class="nav-item {{ request()->routeIs('citas.index') ? 'active' : '' }}" style="display:flex; align-items:center; gap:12px; padding:11px 24px; color:#94a3b8; text-decoration:none; font-size:14px; font-weight:500;">
...
<a href="{{ route('citas.calendario') }}" class="nav-item {{ request()->routeIs('citas.calendario') ? 'active' : '' }}" style="display:flex; align-items:center; gap:12px; padding:11px 24px; color:#94a3b8; text-decoration:none; font-size:14px; font-weight:500;">
...
<a href="{{ route('estadisticas') }}" class="nav-item {{ request()->routeIs('estadisticas') ? 'active' : '' }}" style="display:flex; align-items:center; gap:12px; padding:11px 24px; color:#94a3b8; text-decoration:none; font-size:14px; font-weight:500;">
...
<a href="{{ route('automatizaciones.index') }}" class="nav-item {{ request()->routeIs('automatizaciones.*') ? 'active' : '' }}" style="display:flex; align-items:center; gap:12px; padding:11px 24px; color:#94a3b8; text-decoration:none; font-size:14px; font-weight:500;">
    <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
    Automatizaciones
</a>

<a href="{{ route('email-templates.index') }}" class="nav-item {{ request()->routeIs('email-templates.*') ? 'active' : '' }}" style="display:flex; align-items:center; gap:12px; padding:11px 24px; color:#94a3b8; text-decoration:none; font-size:14px; font-weight:500;">
...
<a href="{{ route('admin.index') }}" class="nav-item {{ request()->is('admin*') ? 'active' : '' }}" style="display:flex; align-items:center; gap:12px; padding:11px 24px; color:#94a3b8; text-decoration:none; font-size:14px; font-weight:500;">
...
@endif
<a href="{{ route('configuracion.index') }}" class="nav-item {{ request()->routeIs('configuracion.*') ? 'active' : '' }}" style="display:flex; align-items:center; gap:12px; padding:11px 24px; color:#94a3b8; text-decoration:none; font-size:14px; font-weight:500;">
    <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l2.03-1.58c.18-.14.23-.41.12-.61l-1.92-3.32c-.12-.22-.37-.29-.59-.22l-2.39.96c-.5-.38-1.03-.7-1.62-.94l-.36-2.54c-.04-.24-.24-.41-.48-.41h-3.84c-.24 0-.43.17-.47.41l-.36 2.54c-.59.24-1.13.57-1.62.94l-2.39-.96c-.22-.08-.47 0-.59.22L2.74 8.87c-.12.21-.08.47.12.61l2.03 1.58c-.05.3-.09.63-.09.94s.02.64.07.94l-2.03 1.58c-.18.14-.23.41-.12.61l1.92 3.32c.12.22.37.29.59.22l2.39-.96c.5.38 1.03.7 1.62.94l.36 2.54c.05.24.24.41.48.41h3.84c.24 0 .44-.17.47-.41l.36-2.54c.59-.24 1.13-.56 1.62-.94l2.39.96c.22.08.47 0 .59-.22l1.92-3.32c.12-.22.07-.47-.12-.61l-2.01-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6z"/></svg>
    Configuración
</a>
        </nav>
    ...
    <div class="main-content">
        ...
        <div style="text-align:center; padding:24px; color:#94a3b8; font-size:12px; border-top:1px solid #e2e8f0; margin-top:auto;">
            © {{ date('Y') }} Timync · Todos los derechos reservados
        </div>
    </div>
