...
<head>
    ...
    <title>Cita confirmada · <?php echo e($negocio->nombre_negocio ?? $negocio->name); ?></title>
    <style>
...
<body>
    <div class="card">
        ...
        <div style="background:#f8fafc; border-radius:8px; padding:16px; margin-bottom:32px; font-size:13px; color:#334155; text-align:left;">
            <div style="font-weight:600; color:#0f172a; margin-bottom:8px;">📍 <?php echo e($negocio->nombre_negocio ?? $negocio->name); ?></div>
            <?php if($negocio->telefono_negocio): ?>
                <div>📞 <?php echo e($negocio->telefono_negocio); ?></div>
            <?php endif; ?>
        </div>
        <a href="<?php echo e(route('negocio.show', $negocio->slug)); ?>" style="display:inline-block; background:<?php echo e($negocio->color_primario ?? '#0f4c81'); ?>; color:white; padding:12px 32px; border-radius:8px; text-decoration:none; font-weight:600; font-size:15px;">
            Hacer otra reserva
        </a>
    </div>
</body>
</html>
<?php /**PATH /home/u759498454/domains/timync.com/public_html/app/resources/views/reserva/confirmacion.blade.php ENDPATH**/ ?>